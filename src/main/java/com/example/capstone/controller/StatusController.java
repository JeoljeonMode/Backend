...
public class StatusController {
	...
	public StatusController(MonitoringService monitoringService, BedConfigService bedConfigService) {
	...
	public ResponseEntity<?> createBed(@RequestBody BedCreateRequest request) {
		try {
			return ResponseEntity.ok(bedConfigService.createBed(request));
